...
installCommon () {
	...
	sudo apt install autoconf autoconf-archive automake autopoint autotools-dev beep binfmt-support build-essential cmake cpufrequtils cpuid cpustat cputool curl dconf-editor debhelper debian-keyring desktop-file-utils devhelp dh-autoreconf dh-make dh-strip-nondeterminism dkms doc-base docutils-common exfat-fuse exo-utils fancontrol ffmpeg ffmpeg-doc ffmpegthumbnailer galternatives gimp gimp-data-extras gimp-help-en git git-gui gitk gmrun gnome-shell-extensions gnome-tweaks gnu-standards gpart gparted hwloc i2c-tools i965-va-driver-shaders icoutils intel-cmt-cat intel-gpu-tools  iotop isag libarchive-cpio-perl libcanberra-gtk-module libdrm-dev libdvdcss2 libfile-stripnondeterminism-perl libgtk-3-dev libhwloc-common libhwloc-dev libhwloc-plugins libi2c-dev libltdl-dev libmail-sendmail-perl libncurses5-dev libncursesw5-dev libportaudio2 libqt5opengl5 libqt5printsupport5 librrds-perl libsensor-msgs-dev libsensors-applet-plugin-dev libsensors4-dev libsigsegv2 libsys-hostname-long-perl libsystemd-dev libtool libudev-dev libvdpau-va-gl1 libvte9 libvulkan-dev libvulkan1 libxml2-dev libxml2-utils lm-sensors m4 meld menu menu-l10n mesa-utils mpv mtools neofetch numlockx openvpn p7zip-full po-debconf python3-docutils python3-oauth2client python3-pkg-resources python3-setuptools python3-smbus python3-tk python3-virtualenv qt5-image-formats-plugins qt5-qmltooling-plugins qtwayland5 read-edid resolvconf rrdtool sl sndiod squashfs-tools squashfuse stunnel4 sysstat tcl-tclreadline terminator thunar thunar-archive-plugin thunar-media-tags-plugin tk tree tumbler-plugins-extra ubuntu-restricted-addons ubuntu-restricted-extras ubuntu-sounds v86d vainfo vdpauinfo virtualenv vlc vulkan-tools wget x11-utils xfce4-settings xsensors xz-utils zstd &&
...
installXenial () {
	...
	cd &&
	sudo apt install python-docutils python-setuptools python-smbus gksu dconf-tools exfat-utils gnome-tweak-tool inteltool rarian-compat vdpau-va-driver libatk-adaptor libgail-common libatk-bridge2.0-0 &&
...
installBionic () {
	...
	cd &&
	sudo apt install python-docutils python-setuptools python-smbus dconf-tools exfat-utils gnome-tweak-tool inteltool rarian-compat vdpau-va-driver libatk-adaptor libgail-common &&
...
installFocal () {
	...
	cd &&
	sudo apt install intel-media-va-driver-non-free libappimage0 libappimage-dev exfatprogs mesa-va-drivers &&
